    ...
    return (
        <section>
            <section className={style.content}>
                <img src={ChaosSpacemarines} alt="Chaos Space Marines" className={style.combat_unit_img} />
                ...
                <div className={style.weapon_content}>
                    ...
                    <div className={style.weaponOther_block}>
                        <div className={style.abilities_title_block}>
                            <div className={style.abilities_title}>Chaos icon</div>
                            <img src={morale} alt="morale" className={style.abilities_symbol} />
                        </div>
                        <div className={style.weaponOther_text}>
                            Каждый раз, когда для подразделения носителя проводится тест на боевое истощение,
                            добавляйте 1 к этому тесту на боевое истощение.
                        </div>
                    </div>
                </div>
            </section>
