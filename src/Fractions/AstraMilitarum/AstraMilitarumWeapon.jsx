...
export const AstraMilitarumWeapon = () => {
    return (
        <div>
        </div>
    )
...
export const Laspistol = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Laspistol</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>12"</div>
...
export const Drum_fed_autogun = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Drum-fed auto</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
...
export const Flamer = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Flamer</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>12"</div>
    ...
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_blockTwo}>
                <div className={style.weapon_title}>Frag grenade</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>24"</div>
...
export const Krak_grenade = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_blockTwo}>
                <div className={style.weapon_title}>Krak grenade</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>24"</div>
...
export const Lasgun = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Lasgun</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>24"</div>
...
export const Meltagun = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Meltagun</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>12"</div>
...
export const Plasma_gun_S = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_blockTwo}>
                <div className={style.weapon_title}>Plasma gun S</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>24"</div>
            ...
            <div className={style.weapon_info_text}>*Если выпала 1 на попадание, владелец уничтожается.</div>
        </div>
    )
}
...
export const Plasma_gun_SС = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_blockTwo}>
                <div className={style.weapon_title}>Plasma gun SС</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>24"</div>
...
export const Chainsword = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Chainsword</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
            ...
            <div className={style.weapon_info_text}>*Дополнительная атака этим оружием.</div>
        </div>
    )
}
...
export const Sols_Righteous_Gaze = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Sol’s Gaze</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>12"</div>
...
export const Conquest = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Conquest</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>-</div>
...
export const Duty_and_Vengeance = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Duty & Vengeance</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>12"</div>
...
export const Power_sword = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Power sword</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>-</div>
...
export const Demolisher_battle_cannon = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Demolisher battle</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>24"</div>
...
export const Eradicator_nova_cannon = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Eradicator nova</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                    ...
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>Hv</div>
                        <div className={style.weapon_text}>D3+6</div>
                    </div>
            ...
            <div className={style.weapon_info_text}>*Цель не получает преимуществ легкого прикрытия.</div>
        </div>
    )
}
...
export const Executioner__cannon_S = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_blockTwo}>
                <div className={style.weapon_title}>Execution plasm S</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>36"</div>
...
export const Executioner__cannon_Sp = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_blockTwo}>
                <div className={style.weapon_title}>Execution plasm Sp</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>36"</div>
...
export const Exterminator_autocannon = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Exterminator auto</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
...
export const Heavy_bolter = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Heavy bolter</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>36"</div>
...
export const Heavy_flamer = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Heavy flamer</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>12"</div>
...
export const Heavy_stubber = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Heavy stubber</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>36"</div>
...
export const Hunter_killer_missile = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Hunter-killer mis</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>48"</div>
            ...
            <div className={style.weapon_info_text}>*Только 1 раз за бой.</div>
        </div>
    )
}
...
export const Leman_Russ_battle_cannon = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Leman Russ bat</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
...
export const Militarum_plasma_S = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_blockTwo}>
                <div className={style.weapon_title}>Militarum plasm S</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>36"</div>
...
export const Militarum_plasma_Sp = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_blockTwo}>
                <div className={style.weapon_title}>Militarum plasm Sp</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>36"</div>
            ...
            <div className={style.weapon_info_text}>*При выпадении 1 на попадание, владелец получает 1 рану.</div>
        </div>
    )
}
...
export const Multi_melta = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Multi-melta</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>24"</div>
...
export const Punisher_gatling_cannon = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Punisher gatling</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>24"</div>
                    ...
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>Hv</div>
                        <div className={style.weapon_text}>20</div>
                    </div>
...
export const Vanquisher_battle_cannon = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Vanquisher battle</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>72"</div>
                    ...
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>S</div>
                        <div className={style.weapon_text}>14</div>
                    </div>
            ...
            <div className={style.weapon_info_text}>*Неуязвимые спасброски не могут быть сделаны против этой атаки, и цель получает смертельные ранения D3 в дополнение к любому обычному урону.</div>
        </div>
    )
}
...
export const Lascannon = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Lascannon</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>48"</div>
...
export const Militarum_multi_laser = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Militarum multilas</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>36"</div>
...
export const Missile_launcher_F = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_blockTwo}>
                <div className={style.weapon_title}>Missile launch F</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>48"</div>
...
export const Missile_launcher_K = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_blockTwo}>
                <div className={style.weapon_title}>Missile launch K</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>48"</div>
...
export const Sentinel_chainsaw = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Sentinel chainsaw</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>-</div>
...
export const Autocannon = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Autocannon</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>48"</div>
...
export const Chimera_heavy_bolter = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Chimera heavy bolter</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>36"</div>
...
export const Chimera_heavy_flamer = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Chir heavy flamer</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>12"</div>
...
export const Chimera_multi_laser = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Chir multi-laser</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>36"</div>
...
export const Lasgun_array = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Lasgun array</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>24"</div>
...
export const Plasma_pistol_S = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_blockTwo}>
                <div className={style.weapon_title}>Plasma pistol S</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>12"</div>
...
export const Plasma_pistol_SP = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_blockTwo}>
                <div className={style.weapon_title}>Plasma pistol Sp</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>12"</div>
...
export const Force_stave = () => {
    return (
        <div className={style.block_text_weapon}>
            <div className={style.weapon_block}>
                <div className={style.weapon_title}>Force stave</div>
                <div className={style.weapon_block_info}>
                    <div className={style.weapon_info}>
                        <div className={style.weapon_text}>R</div>
                        <div className={style.weapon_text}>-</div>
